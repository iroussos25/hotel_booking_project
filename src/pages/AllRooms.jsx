...
const AllRooms = () => {
  ...
  return (
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-26 lg:px-24 xl:px-32'>
      <div>
        ...
        {roomsDummyData.map((room)=>(
            <div key={room._id} className='flex flex-col md:flow-row items-start py-10 gap-6 border-b border-gray-300 last:pb-30 last:border-0'>
